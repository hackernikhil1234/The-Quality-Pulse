    ...
    templates: [
      {
        ...
        description: 'Standard template for daily construction quality checks',
        download: '/templates/daily-inspection.docx',
      },
      {
        title: 'Material Testing Report',
        description: 'Form for material quality test results',
        download: '/templates/material-testing.pdf',
      },
      {
        title: 'Safety Compliance Checklist',
        description: 'Comprehensive safety inspection checklist',
        download: '/templates/safety-checklist.pdf',
      },
      {
        title: 'Progress Report Template',
        description: 'Weekly construction progress reporting',
        download: '/templates/progress-report.docx',
      },
    ],
    guidelines: [
      {
        title: 'Concrete Quality Standards',
        description: 'ASTM and ACI standards for concrete quality',
        download: '/guidelines/concrete-standards.pdf',
      },
      {
        title: 'Steel Reinforcement Guidelines',
        description: 'Proper handling and installation of steel rebar',
        download: '/guidelines/steel-guidelines.pdf',
      },
      {
        title: 'Safety Protocol Manual',
        description: 'Complete safety procedures for construction sites',
        download: '/guidelines/safety-manual.pdf',
      },
      {
        title: 'Environmental Compliance',
        description: 'Environmental regulations and best practices',
        download: '/guidelines/environmental.pdf',
      },
    ],
    training: [
      {
        title: 'Quality Control Basics',
        description: 'Introduction to construction quality assurance',
        link: '#',
        type: 'video',
      },
      {
        title: 'Material Testing Procedures',
        description: 'Step-by-step guide for material testing',
        link: '#',
        type: 'pdf',
      },
      {
        title: 'Report Writing Workshop',
        description: 'How to write effective quality reports',
        link: '#',
        type: 'course',
      },
      {
        title: 'Safety Training Module',
        description: 'Mandatory safety training for site personnel',
        link: '#',
        type: 'course',
      },
    ],
            ...
            {resources[activeCategory].map((resource, index) => (
              <div key={index} className="card p-6 hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className="text-2xl">{activeCategory === 'training' ? '🎓' : '📄'}</span>
                </div>
                ...
                <div className="mt-6">
                  {resource.download ? (
                    ...
                    <button className="btn-secondary w-full py-2">Access Resource</button>
                  )}
                </div>
              </div>
            ))}
