  ...
  const exportPDF = () => {
    ...
    try {
      ...
      if (report.location?.lat)
        fields.push(['GPS Location', `${report.location.lat}, ${report.location.lng}`]);
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {report.issues.map((issue, index) => (
                        <div
                          key={index}
                          className="p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800/30"
                        >
                    ...
                    <p className="text-slate-800 dark:text-slate-300">
                      {(() => {
                        ...
                        if (report.site && typeof report.site === 'object') {
                          ...
                          if (report.site._id)
                            return `Site ID: ${report.site._id.substring(0, 8)}...`;
                        }
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-slate-600 dark:text-slate-400 text-sm mt-1">
                            ...
                            {new Date(report.reviewedAt || report.updatedAt).toLocaleString()}
                          </p>
                        </div>
                        <div>
                          <p className="text-slate-700 dark:text-slate-300">
                            <strong>Comment:</strong>{' '}
                            {report.reviewComment || 'No comment provided'}
                          </p>
                        </div>
                      </div>
                    </div>
